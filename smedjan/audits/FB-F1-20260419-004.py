"""FB-F1-20260419-004: random /safe/* antipattern spot-check.
...
Writes findings table to ~/smedjan/audits/FB-F1-20260419-004.md.
"""
...
OUT_PATH = os.path.expanduser("~/smedjan/audits/FB-F1-20260419-004.md")
...
def main() -> int:
    ...
    lines: list[str] = []
    lines.append(f"# FB-F1-20260419-004 \u2014 /safe/* antipattern spot-check")
    lines.append("")
