"""HTML-level quality audit of 50 existing /compare/ pages (FB-F3-20260419-049).
...
Outputs:
  ~/smedjan/audits/FB-F3-20260419-049.md
  ~/smedjan/audits/FB-F3-20260419-049.sampled_urls.jsonl
"""
