"""HTML-level quality audit of 50 existing /compare/ pages (FB-F3-20260419-033).
...
Outputs:
  ~/smedjan/audits/FB-F3-20260419-033.md
  ~/smedjan/audits/FB-F3-20260419-033.sampled_urls.jsonl
"""
