"""HTML-level quality audit of 50 existing /compare/ pages (FB-F3-20260425-003).
...
Outputs:
  ~/smedjan/audits/FB-F3-20260425-003.md
  ~/smedjan/audits/FB-F3-20260425-003.sampled_urls.jsonl
"""
