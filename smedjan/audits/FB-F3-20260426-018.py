"""HTML-level quality audit of 50 existing /compare/ pages (FB-F3-20260426-018).
...
Outputs:
  ~/smedjan/audits/FB-F3-20260426-018.md
  ~/smedjan/audits/FB-F3-20260426-018.sampled_urls.jsonl
"""
