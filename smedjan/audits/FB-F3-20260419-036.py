"""HTML-level quality audit of 50 existing /compare/ pages (FB-F3-20260419-036).
...
Outputs:
  ~/smedjan/audits/FB-F3-20260419-036.md
  ~/smedjan/audits/FB-F3-20260419-036.sampled_urls.jsonl
"""
