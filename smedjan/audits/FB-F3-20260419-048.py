"""HTML-level quality audit of 50 existing /compare/ pages (FB-F3-20260419-048).
...
Outputs:
  ~/smedjan/audits/FB-F3-20260419-048.md
  ~/smedjan/audits/FB-F3-20260419-048.sampled_urls.jsonl
"""
