"""FB-F1-20260420-025: random /safe/* antipattern spot-check (100 pages).

Per task FB-F1-20260420-025: pull 100 random enriched slugs from Nerq RO
...
OUT_PATH = os.path.expanduser("~/smedjan/audits/FB-F1-20260420-025.md")
...
def main() -> int:
    ...
    lines: list[str] = []
    lines.append("# FB-F1-20260420-025 \u2014 /safe/* antipattern spot-check")
    lines.append("")
