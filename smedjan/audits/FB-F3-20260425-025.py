"""HTML-level quality audit of 50 existing /compare/ pages (FB-F3-20260425-025).
...
Outputs:
  ~/smedjan/audits/FB-F3-20260425-025.md
  ~/smedjan/audits/FB-F3-20260425-025.sampled_urls.jsonl
"""
