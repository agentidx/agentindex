"""HTML-level quality audit of 50 existing /compare/ pages (FB-F3-20260425-008).
...
Outputs:
  ~/smedjan/audits/FB-F3-20260425-008.md
  ~/smedjan/audits/FB-F3-20260425-008.sampled_urls.jsonl
"""
