"""HTML-level quality audit of 50 existing /compare/ pages (FB-F3-20260425-017).
...
Outputs:
  ~/smedjan/audits/FB-F3-20260425-017.md
  ~/smedjan/audits/FB-F3-20260425-017.sampled_urls.jsonl
"""
