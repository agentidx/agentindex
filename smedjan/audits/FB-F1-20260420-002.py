"""FB-F1-20260420-002: random /safe/* antipattern spot-check (100 pages).

Per task FB-F1-20260420-002: pull 100 random enriched slugs from Nerq RO
...
TASK_ID = "FB-F1-20260420-002"
OUT_PATH = os.path.expanduser(f"~/smedjan/audits/{TASK_ID}.md")
