"""HTML-level quality audit of 50 existing /compare/ pages (FB-F3-20260419-032).
...
Outputs:
  ~/smedjan/audits/FB-F3-20260419-032.md
  ~/smedjan/audits/FB-F3-20260419-032.sampled_urls.jsonl
"""
