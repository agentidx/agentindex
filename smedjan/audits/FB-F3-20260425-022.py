"""HTML-level quality audit of 50 existing /compare/ pages (FB-F3-20260425-022).
...
Outputs:
  ~/smedjan/audits/FB-F3-20260425-022.md
  ~/smedjan/audits/FB-F3-20260425-022.sampled_urls.jsonl
"""
