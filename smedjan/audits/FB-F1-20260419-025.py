"""FB-F1-20260419-025: random /safe/* antipattern spot-check.
...
Writes findings table to ~/smedjan/audits/FB-F1-20260419-025.md.
"""
...
OUT_PATH = os.path.expanduser("~/smedjan/audits/FB-F1-20260419-025.md")
...
def main() -> int:
    ...
    lines: list[str] = []
    lines.append(f"# FB-F1-20260419-025 \u2014 /safe/* antipattern spot-check")
    lines.append("")
