"""HTML-level quality audit of 50 existing /compare/ pages (FB-F3-20260419-022).
...
Outputs:
  ~/smedjan/audits/FB-F3-20260419-022.md
  ~/smedjan/audits/FB-F3-20260419-022.sampled_urls.jsonl
"""
