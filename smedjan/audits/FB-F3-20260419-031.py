"""HTML-level quality audit of 50 existing /compare/ pages (FB-F3-20260419-031).
...
Outputs:
  ~/smedjan/audits/FB-F3-20260419-031.md
  ~/smedjan/audits/FB-F3-20260419-031.sampled_urls.jsonl
"""
