"""HTML-level quality audit of 50 existing /compare/ pages (FB-F3-20260425-035).
...
Outputs:
  ~/smedjan/audits/FB-F3-20260425-035.md
  ~/smedjan/audits/FB-F3-20260425-035.sampled_urls.jsonl
"""
