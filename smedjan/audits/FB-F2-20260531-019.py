#!/usr/bin/env python3
"""FB-F2-20260531-019: freshness-refresh prep (read-only, fallback-generated).
...
interpreter that has psycopg2.  Run with:
    /opt/homebrew/bin/python3 smedjan/audits/FB-F2-20260531-019.py
"""
...
OUT_PATH = os.path.expanduser("~/smedjan/audits/FB-F2-20260531-019.csv")
