"""HTML-level quality audit of 50 existing /compare/ pages (FB-F3-20260419-042).
...
Outputs:
  ~/smedjan/audits/FB-F3-20260419-042.md
  ~/smedjan/audits/FB-F3-20260419-042.sampled_urls.jsonl
"""
