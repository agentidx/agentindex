"""HTML-level quality audit of 50 existing /compare/ pages (FB-F3-20260419-037).
...
Outputs:
  ~/smedjan/audits/FB-F3-20260419-037.md
  ~/smedjan/audits/FB-F3-20260419-037.sampled_urls.jsonl
"""
