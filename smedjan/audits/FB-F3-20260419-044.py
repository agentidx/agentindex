"""HTML-level quality audit of 50 existing /compare/ pages (FB-F3-20260419-044).
...
Outputs:
  ~/smedjan/audits/FB-F3-20260419-044.md
  ~/smedjan/audits/FB-F3-20260419-044.sampled_urls.jsonl
"""
