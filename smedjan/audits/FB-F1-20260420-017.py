"""FB-F1-20260420-017: random /safe/* antipattern spot-check (100 pages).

Per task FB-F1-20260420-017: pull 100 random enriched slugs from Nerq RO
...
OUT_PATH = os.path.expanduser("~/smedjan/audits/FB-F1-20260420-017.md")
...
def main() -> int:
    ...
    lines: list[str] = []
    lines.append("# FB-F1-20260420-017 \u2014 /safe/* antipattern spot-check")
    lines.append("")
