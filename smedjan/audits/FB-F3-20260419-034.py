"""HTML-level quality audit of 50 existing /compare/ pages (FB-F3-20260419-034).
...
Outputs:
  ~/smedjan/audits/FB-F3-20260419-034.md
  ~/smedjan/audits/FB-F3-20260419-034.sampled_urls.jsonl
"""
