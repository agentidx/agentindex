"""FB-F2-20260530-017: freshness-refresh prep.
...
smedjan) so it is assembled in Python. Read-only — no enricher call.
"""
...
OUT_PATH = os.path.expanduser("~/smedjan/audits/FB-F2-20260530-017.csv")
