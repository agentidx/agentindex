"""FB-F1-20260419-045: random /safe/* antipattern spot-check (100 pages).
...
OUT_PATH = os.path.expanduser("~/smedjan/audits/FB-F1-20260419-045.md")
...
def main() -> int:
    ...
    lines: list[str] = []
    lines.append("# FB-F1-20260419-045 \u2014 /safe/* antipattern spot-check")
    lines.append("")
