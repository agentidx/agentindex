"""Generate /compare/ coverage proposals for FB-F3-20260419-020.

Pulls highest-demand slugs from smedjan.ai_demand_scores, maps each
slug to the Nerq registries (entity_lookup.source) that carry it,
cross-pairs the top slugs within each registry, ranks pairs by combined
demand, collapses duplicate slug-pairs across registries by retaining
the registry with the highest combined score, then curls
https://nerq.ai/compare/<a>-vs-<b> for the top 50.

Output: /Users/anstudio/smedjan/audits/FB-F3-20260419-020.md
"""
...
def main() -> int:
    ...
    lines = [
        "# FB-F3-20260419-020 /compare/ coverage proposals (top 50 pairs)",
        "",
