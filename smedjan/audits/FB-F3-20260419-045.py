"""HTML-level quality audit of 50 existing /compare/ pages (FB-F3-20260419-045).
...
Outputs:
  ~/smedjan/audits/FB-F3-20260419-045.md
  ~/smedjan/audits/FB-F3-20260419-045.sampled_urls.jsonl
"""
