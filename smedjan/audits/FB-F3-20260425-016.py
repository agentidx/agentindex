"""HTML-level quality audit of 50 existing /compare/ pages (FB-F3-20260425-016).
...
Outputs:
  ~/smedjan/audits/FB-F3-20260425-016.md
  ~/smedjan/audits/FB-F3-20260425-016.sampled_urls.jsonl
"""
