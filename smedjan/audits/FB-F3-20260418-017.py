"""Generate /compare/ coverage proposals for FB-F3-20260418-017.

Same logic as FB-F3-20260418-013/014/015/016: picks highest-demand slugs from
smedjan.ai_demand_scores, maps each slug to the registries
(entity_lookup.source) that carry it, cross-pairs the top slugs within
each registry, ranks pairs by combined demand, and curls
...
OUT = Path("/Users/anstudio/smedjan/audits/FB-F3-20260418-017.md")
TOP_SLUGS_FETCH = 400
...
def main() -> int:
    ...
    lines = [
        "# FB-F3-20260418-017 /compare/ coverage proposals (top 50 pairs)",
        "",
