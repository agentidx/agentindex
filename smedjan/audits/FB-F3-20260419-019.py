"""Generate /compare/ coverage proposals for FB-F3-20260419-019.
...
Output: /Users/anstudio/smedjan/audits/FB-F3-20260419-019.md
"""
...
OUT = Path("/Users/anstudio/smedjan/audits/FB-F3-20260419-019.md")
TOP_SLUGS_FETCH = 2000
TOP_SLUGS_PER_REGISTRY = 25
MAX_PAIRS = 50
EXCLUDE_SLUGS = {"test"}
USER_AGENT = "smedjan-audit/1.0 (+FB-F3-20260419-019)"
...
def main() -> int:
    ...
    lines = [
        "# FB-F3-20260419-019 /compare/ coverage proposals (top 50 pairs)",
        "",
