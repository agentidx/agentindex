"""HTML-level quality audit of 50 existing /compare/ pages (FB-F3-20260419-023).
...
Outputs:
  ~/smedjan/audits/FB-F3-20260419-023.md
  ~/smedjan/audits/FB-F3-20260419-023.sampled_urls.jsonl
"""
