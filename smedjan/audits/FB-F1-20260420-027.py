"""FB-F1-20260420-027: random /safe/* antipattern spot-check.
...
Writes findings table to ~/smedjan/audits/FB-F1-20260420-027.md.
"""
...
OUT_PATH = os.path.expanduser("~/smedjan/audits/FB-F1-20260420-027.md")
...
def main() -> int:
    ...
    lines: list[str] = []
    lines.append(f"# FB-F1-20260420-027 \u2014 /safe/* antipattern spot-check")
    lines.append("")
