"""HTML-level quality audit of 50 existing /compare/ pages (FB-F3-20260427-011).
...
Outputs:
  ~/smedjan/audits/FB-F3-20260427-011.md
  ~/smedjan/audits/FB-F3-20260427-011.sampled_urls.jsonl
"""
