"""Generate /compare/ coverage proposals for FB-F3-20260418-011.

Same shape as FB-F3-20260418-010: pulls highest-demand slugs from
...
Output: /Users/anstudio/smedjan/audits/FB-F3-20260418-011.md
"""
...
def main() -> int:
    ...
    lines = [
        "# FB-F3-20260418-011 /compare/ coverage proposals (top 50 pairs)",
        "",
