"""HTML-level quality audit of 50 existing /compare/ pages (FB-F3-20260419-047).
...
Outputs:
  ~/smedjan/audits/FB-F3-20260419-047.md
  ~/smedjan/audits/FB-F3-20260419-047.sampled_urls.jsonl
"""
