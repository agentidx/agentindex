"""HTML-level quality audit of 50 existing /compare/ pages (FB-F3-20260425-010).
...
Outputs:
  ~/smedjan/audits/FB-F3-20260425-010.md
  ~/smedjan/audits/FB-F3-20260425-010.sampled_urls.jsonl
"""
