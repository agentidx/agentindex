"""HTML-level quality audit of 50 existing /compare/ pages (FB-F3-20260419-041).
...
Outputs:
  ~/smedjan/audits/FB-F3-20260419-041.md
  ~/smedjan/audits/FB-F3-20260419-041.sampled_urls.jsonl
"""
