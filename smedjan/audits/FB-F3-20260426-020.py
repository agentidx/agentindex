"""HTML-level quality audit of 50 existing /compare/ pages (FB-F3-20260426-020).
...
Outputs:
  ~/smedjan/audits/FB-F3-20260426-020.md
  ~/smedjan/audits/FB-F3-20260426-020.sampled_urls.jsonl
"""
