"""FB-F2-20260531-014: freshness-refresh prep.
...
smedjan) so it is assembled in Python. Read-only prep work — no enricher
call; a later non-fallback task consumes the CSV.
"""
...
OUT_PATH = os.path.expanduser("~/smedjan/audits/FB-F2-20260531-014.csv")
