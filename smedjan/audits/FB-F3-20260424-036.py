"""HTML-level quality audit of 50 existing /compare/ pages (FB-F3-20260424-036).
...
Outputs:
  ~/smedjan/audits/FB-F3-20260424-036.md
  ~/smedjan/audits/FB-F3-20260424-036.sampled_urls.jsonl
"""
...
# Local Nerq RO replica may be offline during mac_studio_slot rebuilds; route
# around to the Hel replica via Tailscale if localhost:5432 is not listening.
