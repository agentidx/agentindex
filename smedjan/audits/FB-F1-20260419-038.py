"""FB-F1-20260419-038: random /safe/* antipattern spot-check (100 pages, v1 spec).

Per task FB-F1-20260419-038: pull 100 random enriched slugs from Nerq RO
software_registry, curl https://nerq.ai/safe/<slug>, scan for antipatterns:
literal 'None', literal 'null', empty <td></td>, missing JSON-LD, broken JSON-LD.
Escalate if any single antipattern affects > 5 pages.
"""
...
OUT_PATH = os.path.expanduser("~/smedjan/audits/FB-F1-20260419-038.md")
...
def main() -> int:
    ...
    lines: list[str] = []
    lines.append("# FB-F1-20260419-038 \u2014 /safe/* antipattern spot-check")
    lines.append("")
