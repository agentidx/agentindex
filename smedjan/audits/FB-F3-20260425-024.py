"""HTML-level quality audit of 50 existing /compare/ pages (FB-F3-20260425-024).
...
Outputs:
  ~/smedjan/audits/FB-F3-20260425-024.md
  ~/smedjan/audits/FB-F3-20260425-024.sampled_urls.jsonl
"""
