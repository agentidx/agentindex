"""HTML-level quality audit of 50 existing /compare/ pages (FB-F3-20260419-046).
...
Outputs:
  ~/smedjan/audits/FB-F3-20260419-046.md
  ~/smedjan/audits/FB-F3-20260419-046.sampled_urls.jsonl
"""
