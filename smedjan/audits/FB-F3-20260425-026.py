"""HTML-level quality audit of 50 existing /compare/ pages (FB-F3-20260425-026).
...
Outputs:
  ~/smedjan/audits/FB-F3-20260425-026.md
  ~/smedjan/audits/FB-F3-20260425-026.sampled_urls.jsonl
"""
