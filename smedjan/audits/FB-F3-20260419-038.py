"""HTML-level quality audit of 50 existing /compare/ pages (FB-F3-20260419-038).
...
Outputs:
  ~/smedjan/audits/FB-F3-20260419-038.md
  ~/smedjan/audits/FB-F3-20260419-038.sampled_urls.jsonl
"""
