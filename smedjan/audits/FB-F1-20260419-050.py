"""FB-F1-20260419-050: random /safe/* antipattern spot-check (100 pages).
...
OUT_PATH = os.path.expanduser("~/smedjan/audits/FB-F1-20260419-050.md")
...
def main() -> int:
    ...
    lines: list[str] = []
    lines.append("# FB-F1-20260419-050 \u2014 /safe/* antipattern spot-check")
    lines.append("")
