"""HTML-level quality audit of 50 existing /compare/ pages (FB-F3-20260419-040).
...
Outputs:
  ~/smedjan/audits/FB-F3-20260419-040.md
  ~/smedjan/audits/FB-F3-20260419-040.sampled_urls.jsonl
"""
