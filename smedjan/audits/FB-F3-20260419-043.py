"""HTML-level quality audit of 50 existing /compare/ pages (FB-F3-20260419-043).
...
Outputs:
  ~/smedjan/audits/FB-F3-20260419-043.md
  ~/smedjan/audits/FB-F3-20260419-043.sampled_urls.jsonl
"""
