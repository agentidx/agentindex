"""HTML-level quality audit of 50 existing /compare/ pages (FB-F3-20260425-014).
...
Outputs:
  ~/smedjan/audits/FB-F3-20260425-014.md
  ~/smedjan/audits/FB-F3-20260425-014.sampled_urls.jsonl
"""
