"""HTML-level quality audit of 50 existing /compare/ pages (FB-F3-20260425-029).
...
Outputs:
  ~/smedjan/audits/FB-F3-20260425-029.md
  ~/smedjan/audits/FB-F3-20260425-029.sampled_urls.jsonl
"""
