"""HTML-level quality audit of 50 existing /compare/ pages (FB-F3-20260426-004).
...
Outputs:
  ~/smedjan/audits/FB-F3-20260426-004.md
  ~/smedjan/audits/FB-F3-20260426-004.sampled_urls.jsonl
"""
...
def build_markdown(rows: list[dict], summary: dict) -> str:
    ...
    lines.append(
        ...
        "x Nerq `entity_lookup.source`). URLs already audited in the last 7 days of "
