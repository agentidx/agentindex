"""HTML-level quality audit of 50 existing /compare/ pages (FB-F3-20260425-002).
...
Outputs:
  ~/smedjan/audits/FB-F3-20260425-002.md
  ~/smedjan/audits/FB-F3-20260425-002.sampled_urls.jsonl
"""
