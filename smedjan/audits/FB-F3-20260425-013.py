"""HTML-level quality audit of 50 existing /compare/ pages (FB-F3-20260425-013).
...
Outputs:
  ~/smedjan/audits/FB-F3-20260425-013.md
  ~/smedjan/audits/FB-F3-20260425-013.sampled_urls.jsonl
"""
