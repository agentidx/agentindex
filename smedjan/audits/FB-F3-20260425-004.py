"""HTML-level quality audit of 50 existing /compare/ pages (FB-F3-20260425-004).
...
Outputs:
  ~/smedjan/audits/FB-F3-20260425-004.md
  ~/smedjan/audits/FB-F3-20260425-004.sampled_urls.jsonl
"""
