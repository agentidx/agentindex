"""HTML-level quality audit of 50 existing /compare/ pages (FB-F3-20260425-034).
...
Outputs:
  ~/smedjan/audits/FB-F3-20260425-034.md
  ~/smedjan/audits/FB-F3-20260425-034.sampled_urls.jsonl
"""
