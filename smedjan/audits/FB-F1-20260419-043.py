"""FB-F1-20260419-043: random /safe/* antipattern spot-check (100 pages, v1 spec).

Per task FB-F1-20260419-043: pull 100 random enriched slugs from Nerq RO
...
OUT_PATH = os.path.expanduser("~/smedjan/audits/FB-F1-20260419-043.md")
...
def main() -> int:
    ...
    lines: list[str] = []
    lines.append("# FB-F1-20260419-043 \u2014 /safe/* antipattern spot-check")
    lines.append("")
