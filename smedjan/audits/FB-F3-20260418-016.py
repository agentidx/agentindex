"""Generate /compare/ coverage proposals for FB-F3-20260418-016.

Same logic as FB-F3-20260418-013/014/015: picks highest-demand slugs from
...
OUT = Path("/Users/anstudio/smedjan/audits/FB-F3-20260418-016.md")
TOP_SLUGS_FETCH = 400
...
def main() -> int:
    ...
    lines = [
        "# FB-F3-20260418-016 /compare/ coverage proposals (top 50 pairs)",
        "",
