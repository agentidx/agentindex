"""HTML-level quality audit of 50 existing /compare/ pages (FB-F3-20260423-012).
...
Outputs:
  ~/smedjan/audits/FB-F3-20260423-012.md
  ~/smedjan/audits/FB-F3-20260423-012.sampled_urls.jsonl
"""
...
from smedjan import config as _smedjan_config  # noqa: E402

# Local Nerq RO replica is offline during the 2026-04-23 mac_studio_slot
# rebuild (see /opt/homebrew/etc/pgbouncer.ini comment). Route around it
# to the Hel replica via Tailscale if localhost:5432 is not listening.
if _smedjan_config.NERQ_RO_DSN and "@localhost:5432/" in _smedjan_config.NERQ_RO_DSN:
    ...
    try:
        ...
        _smedjan_config.NERQ_RO_DSN = _smedjan_config.NERQ_RO_DSN.replace(
            "@localhost:5432/", "@100.79.171.54:5432/"
        )
